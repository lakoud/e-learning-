...
import { Box, Button, TextField ,useTheme, Typography ,Divider,Alert } from "@mui/material";
...
export const ProfileScreen = () => {
  ...
  useEffect(() => {
    try {
          ...
          setpasswordConfirm(userInfo.password)
  ...
  return (
    <Box m="20px" >
            ...
            <Divider sx={{ height: 3 , m: "20px"}}  color={colors.grey[300]} />
              ...
              <Box sx={{ borderRadius: '10px', border: '1px solid black' }} justifyContent="center" alignItems="center">
              { err!=null ?
                <Box sx={{mb:'14px'}}>    
